...
export const RelatedCard = (props: Props) => {
  ...
  return (
    <Link href={url}>
      {/* <a className={classNames(styles.card, styles.colortheme1)}> */}
      <a className={getClassNamesForColorTheme(colorTheme)}>
        {/* className={getClassNamesFromButtonUIType(buttonUIType)} */}
        <span aria-hidden="true">{icon}</span>
        {linkText}
        <svg className={styles.arrow} viewBox="0 0 56 44" version="1.1">
          {/* <g id="arrow_right" fill-rule="nonzero"> */}
          <path
            d="M30.34,38 L36,43.66 L54.83,24.83 C55.5811082,24.079727 56.0031466,23.061637 56.0031466,22 C56.0031466,20.938363 55.5811082,19.920273 54.83,19.17 L36,0.34 L30.34,6 L42.34,18 L0,18 L0,26 L42.34,26 L30.34,38 Z"
            id="Path"
          ></path>
          {/* </g> */}
        </svg>
